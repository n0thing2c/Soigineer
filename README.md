...
![Soigineer high-level architecture](report/figures/system-architecture.png)

```text
External Applications
         │ HTTP
         ▼
 Ingestion Gateway ──► Redpanda/raw-logs ──► Logs Processor
                                                    │
                               ┌────────────────────┼──────────────────┐
                               ▼                    ▼                  ▼
                          ClickHouse      processed-logs topic     alert topic
                               │                    │                  │
                               └──────────┬─────────┘                  │
                                          ▼                           ▼
                                   Monitoring Service ◄──── Redis + PostgreSQL
                                          │
                                   REST + WebSocket
                                          │
                                          ▼
